    ...
    <div class="products d-flex">
        <?php if($category_posts): ?>
            <?php foreach($category_posts as $post): ?>
                ...
                <a class="product d-flex justify-content-center align-items-center" href="<?php echo get_the_permalink($post->ID); ?>" style="background-image: url(<?php echo $background_image; ?>);">
