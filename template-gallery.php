...
<div id="content" class="gallery-page">
    <?php if($gallery): ?>
        ...
        <div class="slides-navigation">
            <button type="button" class="prev" aria-label="<?php esc_attr_e('Eelmine pilt', 'Ysse'); ?>"></button>
            <button type="button" class="next" aria-label="<?php esc_attr_e('Järgmine pilt', 'Ysse'); ?>"></button>
        </div>
        ...
        <ul id="bx-pager" class="custom-pager">
            ...
            <?php foreach($gallery as $img): ?>
                <li class="slide">
                    <a class="block" data-slide-index="<?php echo esc_attr($counter); ?>" aria-label="<?php echo esc_attr(sprintf(__('Vaata pilti %d', 'Ysse'), $counter + 1)); ?>">
